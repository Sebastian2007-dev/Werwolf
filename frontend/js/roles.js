...
export const DESCRIPTIONS = {
    ...
    Haendler:      'Schickt jede Runde einen Spieler einkaufen – dieser ist für diese Runde unantastbar und darf nicht am Spiel teilnehmen. Schickt er die Hexe einkaufen, erhält sie beide Tränke zurück.',
    ...
    Gendarm:       'Darf einmalig am Tag vor der Abstimmung eine Person erschießen – gibt sich dabei dem ganzen Dorf zu erkennen. Ist es eine Unschuldige, richtet er sich selbst.',
    Dieb:          'Erhält in der ersten Nacht die zwei übrigen Karten aus dem Kartenpool und kann eine davon als neue Rolle wählen – oder Dieb bleiben.',
    ...
    JackTheRipper: 'Hat keine eigene Aktion. Schläft die Dorfmatratze bei Jack, tötet er sie und mutiert zum Werwolf.',
    Zigeunerin:    'Stirbt automatisch, sobald sie angeklagt wird. Als Rache verflucht sie öffentlich eine Person – diese verwandelt sich in einen Werwolf.',
